...
public class miscellaneous{
  public static void main(String[] args){
    ...
    // generatePropertyComputationCommands("/home/javed/Desktop/matrix_properties/matrices/");
    // addLink(path);
    // generateMatlabScript("/home/javed/Desktop/matrix_properties/properties_parallel/");
  ...
  static void generateParaTargetClassVector(){
    try{
      String path = "/home/javed/Desktop/Florida_Parallel/parallel_data/";
      File dir = new File(path);
      File[] files = dir.listFiles();
      PrintWriter out = new PrintWriter(new 
        BufferedWriter(new FileWriter("para_target_class.txt")));
      ...
      for(int i = 0; i < files.length; i++){
        ...
        if(files[i].getName().contains(".txt")){
          ...
          if(ct != 27) System.out.println(i+"."+files[i].getName());
          //sb.append(cls+" ");
          br.close();
          counter++;
        }        
  ...
  static void dataset(){
    try{
      String path = "/home/javed/Desktop/matrix_properties/properties_parallel/";
      File dir = new File(path);
      File[] files = dir.listFiles();
      int counter = 1;
  ...
  static void generateMatlabScript(String path){
    try{
      ...
      File[] files = dir.listFiles();
      PrintWriter out = new PrintWriter(new 
        BufferedWriter(new FileWriter("prop_para_matrix.txt")));
      StringBuilder sb = new StringBuilder("");
      int counter = 1;
  ...
  static void generatePropertyComputationCommands(String path){
  	path = "/home/javed/Desktop/matrix_properties/matrices_parallel/";
    File dir = new File(path);
    File[] files = dir.listFiles();
